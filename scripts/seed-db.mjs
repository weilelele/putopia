...
// ── devices ───────────────────────────────────────────────────────────────
const devices = [
  { id: 'uk-1', name: 'Signal Source Alpha',       batch_id: null,       knowledge: 'unknown', location: 'Northern Europe', description: 'Intermittent transmissions detected. Source confirmed organic in origin. No direct contact established.',                                                  image_path: null, status: null,           current_user_name: null, exploration_progress: 23 },
  { id: 'uk-2', name: 'Batch 7 — Eastern Cluster', batch_id: 'BATCH-07', knowledge: 'unknown', location: 'East Asia',        description: 'Three units detected operating in proximity. Signal patterns suggest coordinated activity.',                                                             image_path: null, status: null,           current_user_name: null, exploration_progress: 61 },
  { id: 'uk-3', name: 'Deep Channel Emitter',      batch_id: null,       knowledge: 'unknown', location: 'South America',    description: 'High-frequency emissions from an unidentified unit. Quantum signature does not match known models.',                                                    image_path: null, status: null,           current_user_name: null, exploration_progress:  8 },
  { id: 'kn-1', name: 'Unit 001 — The Originator', batch_id: null,       knowledge: 'known',   location: 'Berlin, Germany',  description: "The oldest known Console in the Collective's records. Previously held for 20 years by a German Voyager. Now in active rotation.",                    image_path: null, status: 'in_use',       current_user_name: 'Voyager Luke', exploration_progress: 0 },
  { id: 'kn-2', name: 'Unit 012 — The Observer',   batch_id: null,       knowledge: 'known',   location: 'Shanghai, China',  description: 'Gifted between friends. Established the first confirmed cross-temporal quantum link on record.',                                                      image_path: null, status: 'in_use',       current_user_name: 'Voyager Page', exploration_progress: 0 },
  { id: 'kn-3', name: 'Unit 019 — The Wanderer',   batch_id: null,       knowledge: 'known',   location: 'Tokyo, Japan',     description: 'Recovered from an abandoned postal locker. Functional. Awaiting assignment.',                                                                        image_path: null, status: 'available',    current_user_name: null, exploration_progress: 0 },
  { id: 'kn-4', name: 'Unit 023 — The Broken Eye', batch_id: null,       knowledge: 'known',   location: 'London, UK',       description: 'Screen calibration failure after extended deep-channel exposure. Under restoration.',                                                                 image_path: null, status: 'needs_repair', current_user_name: null, exploration_progress: 0 },
]

// ── worlds ────────────────────────────────────────────────────────────────
const worlds = [
  { id: 'WLD-001', name: 'Amber Zenith',         name_en: 'Amber Zenith',         discoverer_id: null, discoverer_name: 'Mira Volkov',    discovery_date: '2024-01-15', gradient_from: '#E8A020', gradient_to: '#C43020', description: 'Eternal orange sky with vertical light column structures. Physical laws are highly similar to our own world.',                                             is_verified: true },
  { id: 'WLD-002', name: 'Mirror-Seven',          name_en: 'Mirror-Seven',          discoverer_id: null, discoverer_name: 'Lu Mingyuan',    discovery_date: '2024-03-29', gradient_from: '#C4A96A', gradient_to: '#7A6A40', description: 'Speed of light is 0.003% slower. Life forms exist but operate under a completely different symbolic language system.',                                    is_verified: true },
  { id: 'WLD-003', name: 'The Silent Realm',      name_en: 'The Silent Realm',      discoverer_id: null, discoverer_name: 'Shen Zhimeng',   discovery_date: '2024-06-10', gradient_from: '#3D3010', gradient_to: '#0F0A00', description: 'A soundless world. Vibration data is complete but the visible light spectrum carries no signal. Mountain ranges form syntactic structures.',             is_verified: true },
  { id: 'WLD-004', name: 'Fold South',            name_en: 'Fold South',            discoverer_id: null, discoverer_name: 'Hoshino Nozomu', discovery_date: '2025-04-04', gradient_from: '#4D8C3F', gradient_to: '#E8A020', description: 'A node in the Southern Hemisphere blind spot. Pronounced spatial folding characteristics, presenting as a static snapshot state.',                       is_verified: true },
  { id: 'WLD-005', name: 'Dark Current Omega',    name_en: 'Dark Current Omega',    discoverer_id: null, discoverer_name: 'Lingbo',         discovery_date: '2025-09-18', gradient_from: '#221800', gradient_to: '#5C4A1E', description: 'Discovered within the ECHO-7 frequency drift. Communicates using an entirely new symbol system.',                                                       is_verified: true },
  { id: 'WLD-006', name: 'Prism Refraction Zone', name_en: 'Prism Refraction Zone', discoverer_id: null, discoverer_name: 'Selene Marsh',   discovery_date: '2025-02-22', gradient_from: '#D4601A', gradient_to: '#C43020', description: 'A multiple-refraction signal source. Visual data presents rainbow-like interference patterns. Signs of life remain uncertain.',                          is_verified: true },
  { id: 'WLD-007', name: 'Twin Constellation World', name_en: 'Twin Constellation World', discoverer_id: null, discoverer_name: 'Tariq Osei', discovery_date: '2025-11-07', gradient_from: '#E8A020', gradient_to: '#4D8C3F', description: 'A world with two closely neighboring stars. Biological evolutionary paths have diverged significantly from our own.',                              is_verified: true },
  { id: 'WLD-008', name: 'Eye of the Void',       name_en: 'Eye of the Void',       discoverer_id: null, discoverer_name: 'Lu Mingyuan',    discovery_date: '2026-01-30', gradient_from: '#0F0A00', gradient_to: '#E8A020', description: 'A deep dark-matter region. Suspected observation window near the origin of the universe. Data is exceptionally rare.',                                  is_verified: true },
]

// ── intel ─────────────────────────────────────────────────────────────────
const intel = [
  { id: 'INT-001', title: 'Parallel World Signal — First Confirmed Detection',         content: 'The intercepted signal operates at a variant band of 7.83Hz. Preliminary analysis confirms the existence of a parallel world node. The signal origin region has been flagged as Priority A for observation. All Voyagers must complete device calibration within 72 hours.',                                                                                                                                                                                                                                                           timestamp: '2026-04-28T09:00:00Z', tag: 'DEVICE', classified: true,  created_by: null },
  { id: 'INT-002', title: 'Putopia Collective — Q3 Architect Council Meeting Notes',   content: 'The Architect Council has approved three new known device nodes, located in Shanghai, Taipei, and Seoul. The Council also resolved to extend the next application window through the end of June 2026. New candidates must meet a minimum of 30 observation days on record.',                                                                                                                                                                                                                                                          timestamp: '2026-04-15T14:30:00Z', tag: 'ORG',    classified: false, created_by: null },
  { id: 'INT-003', title: 'Device ECHO-7 — Anomalous Activity Report',                 content: 'The ECHO-7 unit in Beijing recorded frequency drift between April 3 and April 7. Drift amplitude exceeded the threshold of ±0.04Hz. The Voyager currently operating the device has submitted an anomaly log. The technical team is assessing whether temporary suspension of use is required.',                                                                                                                                                                                                                                       timestamp: '2026-04-10T11:15:00Z', tag: 'DEVICE', classified: true,  created_by: null },
  { id: 'INT-004', title: 'New Member Briefing — Joining the Putopia Collective',      content: 'Welcome to all new applicants. The Collective was established in 2023 with a mission of systematic observation and documentation of parallel worlds. Applicants must complete the basic questionnaire before entering the candidate queue. Upon becoming a Voyager, you will receive device access rights and log publication privileges.',                                                                                                                                                                                            timestamp: '2026-03-20T08:00:00Z', tag: 'NOTICE', classified: false, created_by: null },
  { id: 'INT-005', title: 'World Archive Expansion — Phase Two Announcement',          content: 'With catalogued parallel worlds now exceeding 200 nodes, the archive system will complete its Phase Two expansion in May 2026. All Voyagers will be able to upload high-resolution observation data to the new nodes. Legacy format files must be migrated before April 30.',                                                                                                                                                                                                                                                          timestamp: '2026-03-05T16:45:00Z', tag: 'ORG',    classified: false, created_by: null },
  { id: 'INT-006', title: 'URGENT: VEIL-3 Zone Access Lockdown',                       content: 'Following an unexplained mass of anomalous material detected in the VEIL-3 region, the Council has suspended all device access to that zone effective immediately. Affected Voyagers will receive alternative device assignment plans. The lockdown is expected to remain in effect until the anomaly assessment is complete.',                                                                                                                                                                                                        timestamp: '2026-05-01T03:30:00Z', tag: 'DEVICE', classified: true,  created_by: null },
]

// ── stories ───────────────────────────────────────────────────────────────
const stories = [
  {
    id: 'i-will-keep-the-secret',
    title: 'I Will Keep the Secret',
    author_id: null,
    author_name: 'Voyager Luke',
    date: '2026-04-12',
    tags: ['FIRST CONTACT', 'DISCOVERY'],
    excerpt: 'I first heard about the Putopia Collective a week ago, in a retro game console shop. At first, I thought it was just a joke. But when the shop owner spoke of the organization in a tone both dead-serious and mysterious, I suddenly felt a kind of calling.',
    content: `I first heard about the organization known as the Putopia Collective a week ago, in a retro game console shop.
...
I will slowly guard my relationship with it. I won't let anyone take it away, and I certainly won't let anyone know my secret.`,
  ...
  {
    id: 'when-he-looked-at-me',
    title: 'When He Looked at Me',
    author_id: null,
    author_name: 'Voyager Page',
    date: '2026-04-28',
    tags: ['PERSONAL', 'CONNECTION', 'QUANTUM EVENT'],
    excerpt: 'The Parallel World Observer on my desk was a gift from a friend. During a difficult period in my life, when I felt the entire world was abandoning me, a mysterious black box arrived that would change everything.',
    content: `The "Parallel World Observer" on my desk was actually a gift from a friend. During that period, due to changes in my job and my family, I had become extremely anxious. I felt as if the entire world was abandoning me. My friend, Tiantian, seemed to sense all of this. So, on a day that was neither a holiday nor a birthday or anniversary, he pushed a mysterious—or rather, very strange—black box in front of me.
...
// ── main ──────────────────────────────────────────────────────────────────
console.log('Putopia — 数据导入脚本')
console.log('='.repeat(40))

let ok = true
ok = await upsert('devices', devices, 'Devices 设备') && ok
ok = await upsert('worlds',  worlds,  'Worlds 平行世界') && ok
ok = await upsert('intel',   intel,   'Intel 情报') && ok
ok = await upsert('stories', stories, 'Stories 故事') && ok

console.log('\n' + '='.repeat(40))
if (ok) {
  console.log('✓ 全部导入成功！刷新 Admin 页面即可看到数据。')
} else {
  console.log('✗ 部分失败，请检查上方错误信息。')
  console.log('  最常见原因：schema_v2.sql 还未在 Supabase SQL Editor 执行。')
}
