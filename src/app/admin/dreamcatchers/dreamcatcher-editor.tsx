          ...
          <fieldset disabled={pending} className={styles.fieldGroup}>
            ...
            <div className={styles.formGrid}>
              {IDENTITY_FIELDS.map((field) => <ArchiveField key={field.key} htmlFor={`dc-${field.key}`} label={field.label}>
                <ArchiveInput id={`dc-${field.key}`} name={field.key} defaultValue={initial[field.key]} placeholder={field.placeholder} maxLength={field.max} required readOnly={!!record && field.key === 'slug'} />
              </ArchiveField>)}
            </div>
          ...
          <fieldset disabled={pending} className={styles.fieldGroup}>
            ...
            <div className={styles.formGrid}>
              {LOCATION_FIELDS.map((field) => <ArchiveField key={field.key} htmlFor={`dc-${field.key}`} label={field.label}>
                <ArchiveInput id={`dc-${field.key}`} name={field.key} defaultValue={initial[field.key]} placeholder={field.placeholder} maxLength={field.max} required list={field.key === 'time_zone' ? 'dreamcatcher-time-zones' : undefined} />
              </ArchiveField>)}
            </div>
