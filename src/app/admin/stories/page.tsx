            ...
            <tbody>
              ...
              {items.map(s => (
                <tr key={s.id}>
                  ...
                  <td style={S.td}>
                    <span style={{ fontSize: 'var(--fs-caption)', padding: '2px 8px', border: '1px solid', color: s.is_published ? '#20D890' : 'rgba(245,245,245,0.35)', borderColor: s.is_published ? 'rgba(32,216,144,0.4)' : 'rgba(227,82,5,0.16)' }}>
