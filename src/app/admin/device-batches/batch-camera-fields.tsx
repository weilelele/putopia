...
import { ArchiveSelect, ArchiveInput } from '@/components/archive-input'
  ...
  return <div className={styles.formCard}>
    ...
    {value ? <>
      ...
      <div className={styles.threeColumnGrid}>
        ...
        <ArchiveField htmlFor="batch-camera-fit" label="FRAME FIT"><ArchiveSelect id="batch-camera-fit" value={value.fit} onChange={(event) => onChange({ ...value, fit: event.target.value === 'cover' ? 'cover' : 'contain' })}><option value="contain">Full frame</option><option value="cover">Fill and crop</option></ArchiveSelect></ArchiveField>
      </div>
