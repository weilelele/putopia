...
function PackTracker({ order, index, total }: { order: VoyagerOrder; index: number; total: number }) {
  ...
  return (
    <div style={{ border: '1px solid rgba(227,82,5,0.2)', background: '#0F1430', padding: '18px 20px', marginBottom: '16px' }}>
...
export default function ProfilePage() {
  ...
  return (
    <div className="main">
      ...
      {/* Identity header */}
      <div style={{ display: 'flex', gap: '18px', alignItems: 'center', border: '1px solid rgba(227,82,5,0.2)', background: '#0F1430', padding: '20px', marginBottom: '24px', flexWrap: 'wrap' }}>
            ...
            {isApplicant && (
              <Link
                ...
                style={{
                  ...
                  color: '#E35205', border: '1px solid rgba(227,82,5,0.45)',
      ...
      {!canEdit ? (
        <div style={{ border: '1px solid rgba(227,82,5,0.16)', background: '#0F1430', padding: '22px 20px', fontFamily: 'var(--font-mono)', maxWidth: '640px', display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
          ...
          <Link
            ...
            style={{
              ...
              border: '1px solid rgba(200,68,6,0.5)', color: '#F5F5F5', fontWeight: 700,
      ...
      <div style={{ border: '1px solid rgba(227,82,5,0.16)', background: '#0F1430', padding: '20px', fontFamily: 'var(--font-mono)', maxWidth: '640px' }}>
        <div style={{ color: '#C84406', fontSize: 'var(--fs-caption)', letterSpacing: '0.25em', marginBottom: '18px' }}>{"// ADD YOUR INFO"}</div>
