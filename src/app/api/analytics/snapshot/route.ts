...
export async function GET(request: NextRequest) {
  ...
  // ── Supabase: registrations & voyagers ─────────────────────────────────────
  ...
  const steps = [
    ...
    { key: 'onboarding_email_submitted', label: 'Email Submitted',    order: 5, all: byEvent(allTimeRows, 'onboarding_email_submitted'), d30: byEvent(window30dRows, 'onboarding_email_submitted') },
