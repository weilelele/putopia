...
export async function GET(request: NextRequest) {
  ...
  const steps = [
    ...
    { key: 'onboarding_slider_touched',  label: 'Slider Touched',      order: 4, all: byEvent(allTimeRows, 'onboarding_slider_touched'), d30: byEvent(window30dRows, 'onboarding_slider_touched') },
    { key: 'onboarding_q3_completed',    label: 'Q3 · Urgency',        order: 5, all: byEvent(allTimeRows, 'onboarding_q3_completed'),   d30: byEvent(window30dRows, 'onboarding_q3_completed') },
