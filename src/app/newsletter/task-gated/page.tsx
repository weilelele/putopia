    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="padding:24px 28px 20px;">
      <tr>
        ...
        <td style="text-align:right;vertical-align:top;">
          <div style="display:inline-block;border:1px solid rgba(232,160,32,0.45);padding:4px 10px;background:rgba(232,160,32,0.06);">
            <div style="font-size:7px;letter-spacing:0.2em;color:rgba(232,160,32,0.55);">STATUS</div>
            <div style="font-size:10px;font-weight:700;letter-spacing:0.18em;color:#E8A020;">APPLICANT</div>
          </div>
        </td>
      </tr>
    </table>
