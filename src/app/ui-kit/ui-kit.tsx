    ...
    <div className="uk-grid">
      <section className="uk-section uk-span"><h2>NAV-01 · Primary tabs</h2><p>Dashboard / Intel / Devices / Worlds / Voyagers. Select a preview below.</p>
        ...
        <div className="uk-phone">
          {!['logs','profile'].includes(view) ? <><ArchiveBrandHeader /><h2 className="uk-page-title">{view.toUpperCase()}</h2></> : <><ArchiveButton type="submit" variant="ghost" className="back-link" onClick={() => setView(source)}>← Back to {source}</ArchiveButton><h2 className="uk-page-title">{view === 'logs' ? 'VOYAGER LOGS' : 'MY PROFILE'}</h2></>}
