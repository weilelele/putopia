...
export function Sidebar() {
  ...
  return <aside className="sidebar" aria-label="Workspace navigation" aria-busy={loading}>
    {!(path === '/console' && guest) && <Link href="/console" className="sidebar-logo" aria-label="Multiverse Collective · Dashboard"><SmartImage src="/assets/vi-icon.png" alt="" width={56} height={32} sizes="56px" /><SmartImage className="sidebar-wordmark" src="/assets/vi-wordmark.png" alt="Multiverse Collective" width={128} height={36} sizes="128px" /></Link>}
