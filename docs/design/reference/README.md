...
**2.3 更新 · 2026-09-09：一级 Tab 页面可以保留 Logo，五页采用统一的克制品牌区；Voyager Logs 等二级及更深页面不显示 Logo。纠正 2.2 将所有一级页品牌块一律作废的说明。原图未重绘，品牌区具体尺寸、留白与页面标题按 2.3 规范执行，资产本身不变。**
...
这是一张全页长图，不要求把十条动态装进一个手机视口。实现基准在 [组件说明 C11/C12](../ui-components.md)：390px 宽时缩略图 120×80，文字真实渲染，页面纵滚、Events 横滚、底栏固定在视口底部。
